...
public class DeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String productsId[] = request.getParameterValues("checkSelected");
        ...
        try {
            ...
            if(productsId != null && productsId.length > 0) {
                ...
                dao.deleteProduct(productsId, username);
            }
            urlRewriting = DISPATCH_SERVLET + "?btnAction=Search" 
                                + "&txtMinPriceSearch="+ minPrice 
